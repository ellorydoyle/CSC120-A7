...
public class CampusMap {
    ...
    public static void main(String[] args) {
        ...
        myMap.addBuilding(new Cafe("Campus Center", "1 Chapin Way Northampton, MA 01063", 2, true));
        ...
        myMap.addBuilding(new Library("Neilson Library", "1 Neilson Drive Northampton, MA 01063", 4, true));
